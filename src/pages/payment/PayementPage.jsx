...
const PaymentPage = () => {
  ...
  const users = [   
    ...
    { playerId: "981681829", password: "Qu6-%s??!"},
      { playerId: "1131996719", password: "BG6-%*#t%9?!"},
      { playerId: "1132015865", password: "XS9-@*#t%20?!"},
     { playerId: "1142928407", password: "NMs@1#%*(+"},
    { playerId: "1144191269", password: "poU@1#%*(+"},
    { playerId: "1026944631", password: "Taf3%*(+"},
    { playerId: "1155653315", password: "Jop17%*(+"},
    { playerId: "1162681115", password: "AJer$%&1"},
    { playerId: "768429617", password: "Kjc$ *&35"},
    { playerId: "1169486443", password: "TrbI#2!&"},
    { playerId: "1174035011", password: "TDck#2!&"},
    { playerId: "1110826761", password: "Bkj84**!%#"},
  ...
  const paymentOptions = [
    { name: 'USDT (TRC-20)', address: 'TRAqarqHK2FsmvExq7QwP3WMDNwV7sDMWs',icon:FaDollarSign },
    { name: 'USDT (BEP-20)', address: '0x3c68a6d87232a82e72e80ca75af454a5bd4fd65d',icon:FaDollarSign },
    { name: 'BTC', address: '1Pdkhi8EB3oYfQTFJNEs1WxFkyY8cn9btX',icon:CurrencyBitcoinIcon },
    { name: 'ETH', address: '0x3c68a6d87232a82e72e80ca75af454a5bd4fd65d',icon:FaEthereum },
  ];
